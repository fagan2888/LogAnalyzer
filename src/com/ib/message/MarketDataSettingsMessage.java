...
public class MarketDataSettingsMessage extends SettingsMessage{
	...
	public static final String[] MARKETDATASETTINGSTAGS = {"showFrozenMarketDataForIndex", "showFrozenMarketData"
		, "autoShowFrozenMarketDataForIndex", "showFrozenMarketData", "autoShowFrozenMarketData"
	...
	public void addAttrToEsignalSecSettingsListOpt(String key, HashMap<String, String> value){
	...
	public void addAttrToEsignalSecSettingsListStk(String key, HashMap<String, String> value){
	...
	public void addAttrToEsignalSecSettingsListFut(String key, HashMap<String, String> value){
	...
	public HashMap<String, HashMap<String, String>> getCopyEsignalSecSettingsListFut(){
		return new HashMap<String, HashMap<String, String>>(eSignalSecSettingsListFut);
	}
	
	public void addAttrToEsignalSecSettingsListInd(String key, HashMap<String, String> value){
